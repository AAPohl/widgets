...
### Widget Calls:
`{{ power.powerflow (id, item_pvPower, item_gridPower, item_batteryPower, item_housePower, item_vehiclePower, item_heatingPower, item_batterySoC, item_vehicleSoc, item_heatingSoC) }}`

<img width="291" height="330" alt="grafik" src="https://github.com/user-attachments/assets/cc8eef1b-72b6-4607-a7eb-f42913f72019" />

`{{ power.powerdistribution(id, item_pvPower, item_gridPower, item_batteryPower, item_housePower, item_vehiclePower, item_heatingPower, item_batterySoC, item_vehicleSoc, item_heatingSoC) }}`
